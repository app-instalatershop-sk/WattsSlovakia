...
const sk = {
  ...
  home: {
    h1a: 'Microflex.', h1b: 'Predizolované potrubie, ktoré sa ohne okolo prekážky.',
    lead: 'Vykurovanie, pitná voda, chladenie a tepelné čerpadlá. Jeden kus z kotúča, pod zemou bez spojov.',
    cta: 'Vybrať potrubie', cta2: 'Katalóg PDF',
    facts: { polomer: 'Polomer ohybu', rura: 'Nosná rúra', tlak: 'Prevádzkový tlak', rady: 'Potrubných radov' },
    pouzitieH2: 'Na čo potrubie potrebujete',
    pouzitia: [
      { slug: 'vykurovanie', nazov: 'Vykurovanie', text: 'Od kotolne alebo tepelného čerpadla k domu. UNO a DUO, 6 bar.', pikto: 'rad-duo-kurenie.png' },
      { slug: 'sanita', nazov: 'Teplá a studená voda', text: 'Pitná voda medzi budovami. UNO a DUO v sanitárnom vyhotovení, 10 bar.', pikto: 'rad-duo-sanita.png' },
      { slug: 'studena-a-chladena-voda', nazov: 'Chladenie a studená voda', text: 'Chladená, studená aj odpadová voda. COOL, aj s vyhrievacím káblom.', pikto: 'rad-cool-uno.png' },
      { slug: 'tepelne-cerpadla', nazov: 'Tepelné čerpadlo', text: 'Prívod, spiatočka a káble k vonkajšej jednotke v jednom plášti. HP.', pikto: 'rad-hp-tepelne-cerpadlo.png' },
    ],
    katalogH2: 'Katalóg', katalogP: 'Päť potrubných systémov a k nim spojky a príslušenstvo. Všetko, čo treba na jeden výkop.',
...
const cs: typeof sk = {
  ...
  home: {
    h1a: 'Microflex.', h1b: 'Předizolované potrubí, které se ohne kolem překážky.',
    lead: 'Vytápění, pitná voda, chlazení a tepelná čerpadla. Jeden kus z kotouče, pod zemí bez spojů.',
    cta: 'Vybrat potrubí', cta2: 'Katalog PDF',
    facts: { polomer: 'Poloměr ohybu', rura: 'Nosná trubka', tlak: 'Provozní tlak', rady: 'Potrubních řad' },
    pouzitieH2: 'Na co potrubí potřebujete',
    pouzitia: [
      { slug: 'vytapeni', nazov: 'Vytápění', text: 'Od kotelny nebo tepelného čerpadla k domu. UNO a DUO, 6 bar.', pikto: 'rad-duo-kurenie.png' },
      { slug: 'sanita', nazov: 'Teplá a studená voda', text: 'Pitná voda mezi budovami. UNO a DUO v sanitárním provedení, 10 bar.', pikto: 'rad-duo-sanita.png' },
      { slug: 'studena-a-chlazena-voda', nazov: 'Chlazení a studená voda', text: 'Chlazená, studená i odpadní voda. COOL, i s topným kabelem.', pikto: 'rad-cool-uno.png' },
      { slug: 'tepelna-cerpadla', nazov: 'Tepelné čerpadlo', text: 'Přívod, zpátečka a kabely k venkovní jednotce v jednom plášti. HP.', pikto: 'rad-hp-tepelne-cerpadlo.png' },
    ],
    katalogH2: 'Katalog', katalogP: 'Pět potrubních systémů a k nim spojky a příslušenství. Všechno, co je třeba na jeden výkop.',
