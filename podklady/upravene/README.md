...
| 4 | `podklady/watts/fotky-rady/microflex-uno-6-bar.jpg`, `microflex-duo-6-bar.jpg`, `microflex-uno-primo-6-bar.jpg`, `microflex-uno-10-bar.jpg`, `microflex-duo-10-bar.jpg`, `microflex-cool.png`, `microflex-cool-duo.png`, `microflex-cool-s-vyhrievacim-kablom.png`, `microflex-hp.png` (1000 px) | odstrániť biele pozadie, priehľadné pozadie, veľkosť ponechať | `rady/<rovnaký názov>.png` | karty katalógu a galéria na stránke radu na radiálnej ploche |
| 5 | `podklady/watts/fotky-rady/microflex-quadro.png` (500 × 500) | upscale na 1200 px, odstrániť pozadie | `rady/microflex-quadro.png` | to isté, QUADRO je dnes jediný malý render |
