...
const sk = {
  ...
  home: {
    ...
    maticaPopis: 'V riadku je systém s médiom a tlakom, v stĺpci počet rúr v jednom plášti. Rad otvorí tabuľku rozmerov a objednávacích čísel.',
    maticaSystem: 'Systém',
    vyberStlpce: ['1 rúra v plášti', '2 rúry v plášti', '4 rúry v plášti'],
    vyberPrazdne: 'v tomto vyhotovení sa rad nevyrába',
    vyberSprievodca: 'Sprievodca výberom v troch krokoch',
    katalogH2: 'Katalóg Microflex', katalogP: 'Päť potrubných systémov a k nim spojky a príslušenstvo. Všetko, čo treba na jeden výkop.',
...
const cs: typeof sk = {
  ...
  home: {
    ...
    maticaPopis: 'V řádku je systém s médiem a tlakem, ve sloupci počet trubek v jednom plášti. Řada otevře tabulku rozměrů a objednacích čísel.',
    maticaSystem: 'Systém',
    vyberStlpce: ['1 trubka v plášti', '2 trubky v plášti', '4 trubky v plášti'],
    vyberPrazdne: 'v tomto provedení se řada nevyrábí',
    vyberSprievodca: 'Průvodce výběrem ve třech krocích',
    katalogH2: 'Katalog Microflex', katalogP: 'Pět potrubních systémů a k nim spojky a příslušenství. Všechno, co je třeba na jeden výkop.',
